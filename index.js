...
const fox = '5527999343206';
const bot = '15716695581';
const atos = '5527997451077';
const instagram = 'http://www.instagram.com/foxgg.av';
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n'
  + 'FN:Foxgg\n' // Nama kamu
  + 'ORG:Foxgg;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=5527999343206:+55 27 99934-3206\n' //Nomor whatsapp kamu
  + 'END:VCARD'
//
const
  {
...
conn.on('message-new', async (m) => {
  ...
  //Conchas magicas
  if (text.includes('.Oque')) {
    conn.sendMessage(id, 'Repita o comando com minúscula\n_exemplo : .oque eu amo ela_', MessageType.text, { quoted: m });
  }
  if (text.includes('.Posso')) {
    conn.sendMessage(id, 'Repita o comando com minúsculas\n_exemplo : .posso eu amo ele_', MessageType.text, { quoted: m });
  }
  if (text.includes('.Quando')) {
    conn.sendMessage(id, 'Repita o comando com minúsculas\n_exemplo : .quando eu gosto dela_', MessageType.text, { quoted: m });
  }
  if (text.includes('.Oque')) {
  ...
  if (text.includes('.Setname')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas, ele só funciona se o bot se tornar um administrador', MessageType.text, { quoted: m });
  }
  if (text.includes(".setname")) {
...
_“Fique longe do fogo do inferno nem que seja doando uma data (um pouco). Se nao tiver, pode ser com a palavra thayybah” [HR. Bukhari 6539, Muslim 1016]_

*Fox :* _${fox}_
*Bot :* _${bot}_
*Atos :* _${atos}_`, MessageType.text, { quoted: m });
  }

  //Informasi
  if (text.includes('.info')) {
    conn.sendMessage(id, 'Problema com o bot? mande mensagem para o dono 5527999343206 \nAtau gunakan fitur *.Bug*\n_Contoh : .bug fitur cerpen tidak bisa_', MessageType.text, { quoted: m });
  }
...
╠════════════════════` , MessageType.text);
  ...
  if (text.includes('.Tagme')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas', MessageType.text, { quoted: m });
  }
  if (text.includes('.tagme')) {
    var nomor = m.participant
    const options = {
      text: `@${nomor.split("@s.whatsapp.net")[0]} Oi lindo🤗`,
      contextInfo: { mentionedJid: [nomor] }
    }
  ...
  if (text.includes('.Say')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .say Lexa gans_', MessageType.text, { quoted: m });
  }
  if (text.includes(".say")) {
  ...
  if (text.includes('.Ytmp4')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .ytmp4 http://youtube..._', MessageType.text, { quoted: m });
  }
  if (text.includes('.ytmp4')) {
    ...
    axios.get(`https://kocakz.herokuapp.com/api/media/ytvideo?url=${teks}`).then((res) => {
      imageToBase64(res.data.result.thumb)
        .then(
          (ress) => {
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, '[ WAIT ] Carregando...⏳ Espere um pouco', MessageType.text, { quoted: m })
  ...
  if (text.includes('.Ytmp3')) {
    conn.sendMessage(id, 'SRepita o comando em letras minúsculas\n_exemplo : .ytmp3 http://www.youtube..._', MessageType.text, { quoted: m });
  }
  if (text.includes('.ytmp3')) {
  ...
  if (text.includes('.Thunder')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .thunder Fox_', MessageType.text, { quoted: m });
  }
  if (text.includes('.thunder')) {
  ...
  if (text.includes('.Sand1')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .sand1 Fox_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand1')) {
  ...
  if (text.includes('.Neon3d')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .neon3d Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.neon3d')) {
  ...
  if (text.includes('.Blackpink')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .Blackpink Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.blackpink')) {
  ...
  if (text.includes('.Cloud')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .cloud Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.cloud')) {
  ...
  if (text.includes('.Sky')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .sky Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sky')) {
  ...
  if (text.includes('.Sand2')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .sand2 Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand2')) {
  ...
  if (text.includes('.Sand3')) {
    conn.sendMessage(id, 'Repita o comando em letras minúsculas\n_exemplo : .sand3 Lexa_', MessageType.text, { quoted: m });
  }
  if (text.includes('.sand3')) {
